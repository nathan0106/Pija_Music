...
func init() {
	orm.RegisterModel(new(Canciones))
}

// AddCanciones insert a new Canciones into database and returns
...
// GetCancionesById retrieves Canciones by Id. Returns error if
// Id doesn't exist
func GetCancionesById(id int) (v *Canciones, err error) {
	o := orm.NewOrm()
	v = &Canciones{Id: id}
...
// GetAllCanciones retrieves all Canciones matches certain condition. Returns empty list if
// no records exist
...
// UpdateCanciones updates Canciones by Id and returns error if
...
// DeleteCanciones deletes Canciones by Id and returns error if
// the record to be deleted doesn't exist
func DeleteCanciones(id int) (err error) {
	o := orm.NewOrm()
	v := Canciones{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&Canciones{Id: id}); err == nil {
