...
func init() {
	orm.RegisterModel(new(Lugares))
}

// AddLugares insert a new Lugares into database and returns
...
// GetLugaresById retrieves Lugares by Id. Returns error if
// Id doesn't exist
func GetLugaresById(id int) (v *Lugares, err error) {
	o := orm.NewOrm()
	v = &Lugares{Id: id}
...
// GetAllLugares retrieves all Lugares matches certain condition. Returns empty list if
// no records exist
...
// UpdateLugares updates Lugares by Id and returns error if
...
// DeleteLugares deletes Lugares by Id and returns error if
// the record to be deleted doesn't exist
func DeleteLugares(id int) (err error) {
	o := orm.NewOrm()
	v := Lugares{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&Lugares{Id: id}); err == nil {
