...
// @Success 201 {int} models.Coplas
// @Failure 403 body is empty
// @router / [post]
func (c *CoplasController) Post() {
	var v models.Coplas
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCoplas(&v); err == nil {
...
func (c *CoplasController) GetAll() {
	...
	l, err := models.GetAllCoplas(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
...
func (c *CoplasController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Coplas{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateCoplasById(&v); err == nil {
...
func (c *CoplasController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteCoplas(id); err == nil {
